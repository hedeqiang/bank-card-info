...
class BankName
{
    ...
    public static function getCardType($typeCode = null)
    {
        return self::$cardTypes[$typeCode] ?? null;
    }
    ...
    public static function getBankName($bankCode = null)
    {
        return self::$bankInfo[$bankCode] ?? null;
    }
